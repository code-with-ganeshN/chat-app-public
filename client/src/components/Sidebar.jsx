...
const Sidebar = () => {
    ...
    // Fetch users when component mounts or onlineUsers change
    useEffect(() => {
    ...
    const handleSelectUser = (user) => {
        if (!user) {
            console.warn("Attempted to select an undefined user.");
            return;
        }

        console.log("User clicked:", user.fullName, "| ID:", user._id);

        // Reset selectedUser to force UI update
